...
class RAGEngine:
    ...
    def add_document(self, file_path: str) -> Dict[str, Any]:
        ...
        console.print(f"[green]✓ Created {len(doc_chunks)} chunks[/green]")
    ...
    def add_directory(self, directory_path: str) -> Dict[str, Any]:
        ...
        console.print(f"[green]✓ Loaded {len(docs)} documents, {len(self.chunks)} total chunks[/green]")
    ...
    def build_index(self):
        ...
        console.print(f"[green]✓ Index built with {self.vector_store.size} vectors[/green]")
...
Please provide a helpful answer based on the context above."""
    ...
    def save(self, path: str = None):
        ...
        console.print("[green]✓ RAG engine saved[/green]")
